...
from multimodal_model import MultiModalHemoglobinModel  # your model definition
import numpy as np
...
class MultiModalDataset(Dataset):
    def __init__(self, df, data_dir):
        ...
        # Use dummy metadata (all zeros) since we don’t have real metadata
...
# ---------------- Load model ----------------
model = MultiModalHemoglobinModel(metadata_input_dim=1)  # match checkpoint
